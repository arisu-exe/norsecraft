...
public class NiflheimSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public NiflheimSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
    ...
    private void apply(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, BlockState top, BlockState middle, BlockState bottom, int sealevel) {
