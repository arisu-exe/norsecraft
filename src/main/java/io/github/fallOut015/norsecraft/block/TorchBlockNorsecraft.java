...
public class TorchBlockNorsecraft extends Block {
    protected static final VoxelShape AABB = Block.box(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
    protected final LazyValue<IParticleData> flameParticle;

    public TorchBlockNorsecraft(AbstractBlock.Properties properties, Supplier<IParticleData> flameParticle) {
        super(properties);
        this.flameParticle = new LazyValue<>(flameParticle);
    }
    ...
    public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
        ...
        p_180655_2_.addParticle(this.flameParticle.get(), d0, d1, d2, 0.0D, 0.0D, 0.0D);
    }
}
